...
ActiveRecord::Schema.define(version: 20170201194503) do
  ...
  create_table "artist_events", force: :cascade do |t|
    ...
    t.index ["artist_id", "event_id"], name: "index_artist_events_on_artist_id_and_event_id", unique: true, using: :btree
  ...
  create_table "artist_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artist_id", "user_id"], name: "index_artist_users_on_artist_id_and_user_id", unique: true, using: :btree
    t.index ["artist_id"], name: "index_artist_users_on_artist_id", using: :btree
    t.index ["user_id"], name: "index_artist_users_on_user_id", using: :btree
  end
